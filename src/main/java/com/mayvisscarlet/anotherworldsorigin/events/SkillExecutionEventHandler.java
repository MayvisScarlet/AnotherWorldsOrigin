...
import com.mayvisscarlet.anotherworldsorigin.skills.SkillExecutionManager;
...
public class SkillExecutionEventHandler {
    ...
    public static void onAttackEntity(AttackEntityEvent event) {
        ...
        if (SkillExecutionManager.isExecutingSkill(player)) {
            ...
            AnotherWorldsOrigin.LOGGER.debug("Blocked attack during skill execution for {}", 
    ...
    public static void onLeftClickBlock(PlayerInteractEvent.LeftClickBlock event) {
        ...
        if (SkillExecutionManager.isExecutingSkill(player)) {
            if (event.isCancelable()) {
                ...
                AnotherWorldsOrigin.LOGGER.debug("Blocked left click block during skill execution for {}", 
                    player.getDisplayName().getString());
            }
        }
    }
    ...
    public static void onRightClickItem(PlayerInteractEvent.RightClickItem event) {
        ...
        if (SkillExecutionManager.isExecutingSkill(player)) {
            if (event.isCancelable()) {
                ...
                AnotherWorldsOrigin.LOGGER.debug("Blocked right click item during skill execution for {}", 
                    player.getDisplayName().getString());
            }
        }
    }
    ...
    public static void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (SkillExecutionManager.isExecutingSkill(player)) {
            if (event.isCancelable()) {
                ...
                AnotherWorldsOrigin.LOGGER.debug("Blocked right click block during skill execution for {}", 
                    player.getDisplayName().getString());
            }
        }
    }
    ...
    public static void onItemUseStart(LivingEntityUseItemEvent.Start event) {
        if (event.getEntity() instanceof Player player && SkillExecutionManager.isExecutingSkill(player)) {
            if (event.isCancelable()) {
                ...
                AnotherWorldsOrigin.LOGGER.debug("Blocked item use start during skill execution for {}", 
                    player.getDisplayName().getString());
            }
        }
    }
    ...
    public static void onItemUseTick(LivingEntityUseItemEvent.Tick event) {
        if (event.getEntity() instanceof Player player && SkillExecutionManager.isExecutingSkill(player)) {
            if (event.isCancelable()) {
                ...
                AnotherWorldsOrigin.LOGGER.debug("Blocked item use tick during skill execution for {}", 
                    player.getDisplayName().getString());
            }
        }
    }
    ...
    public static void onBlockBreak(BlockEvent.BreakEvent event) {
        ...
        if (SkillExecutionManager.isExecutingSkill(player)) {
            if (event.isCancelable()) {
                ...
                AnotherWorldsOrigin.LOGGER.debug("Blocked block break during skill execution for {}", 
                    player.getDisplayName().getString());
            }
        }
    }
    ...
    public static void onBlockPlace(BlockEvent.EntityPlaceEvent event) {
        if (event.getEntity() instanceof Player player && SkillExecutionManager.isExecutingSkill(player)) {
            if (event.isCancelable()) {
                ...
                AnotherWorldsOrigin.LOGGER.debug("Blocked block place during skill execution for {}", 
                    player.getDisplayName().getString());
            }
        }
    }
    ...
    public static void onEntityMount(net.minecraftforge.event.entity.EntityMountEvent event) {
        if (event.getEntity() instanceof Player player && SkillExecutionManager.isExecutingSkill(player)) {
            if (event.isCancelable() && event.isMounting()) {
                ...
                AnotherWorldsOrigin.LOGGER.debug("Blocked entity mount during skill execution for {}: {}", 
    ...
    private static void showEntityInteractionMessage(Player player, String entityType, net.minecraft.world.entity.Entity target) {
        ...
        AnotherWorldsOrigin.LOGGER.debug("Blocked {} interaction during skill execution for {}: {} ({})", 
